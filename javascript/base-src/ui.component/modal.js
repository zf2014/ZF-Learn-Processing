...
;(function($, S, undefined) {
    ...
    var global = window,
        ...
        isIE6 = zjport.UA.ie === 6,  // IE6
        
        MODAL_SELECTOR = '.js-pop-modal',
        MODAL_DATA_CACHE = 'zjp.data.modal',
        MODAL_EVENT_NAMESPACE = '.zjp.event.modal',
    ...
    that.dialog = function(str, handlers, options) {
        ...
        parts.push('<div class="modal js-pop-modal" style="overflow:hidden";>');
        if (options['header']) {
